...
// TESTS
var crea = new crea_1.crea(); // CREATE THE GRAPH
...
checkAndPrint(crea.routeDistance(["A", "E", "D"]), crea_1.NOROUTE);
// TEST CASE 6
print("6. The number of trips starting at C and ending at C with a maximum of 3\nstops.  In the sample data below, there are two such trips: C-D-C (2\nstops). and C-E-B-C (3 stops).");
var allRoutes6 = crea.allRoutesForAMaximunNumberOfStops("C", "C", 3);
...
var allRoutes7 = crea.allRoutesForANumberOfStops("A", "C", 4);
...
var allRoutes10 = crea.allOfRoutesMaximunDistance("C", "C", 29);
...
//# sourceMappingURL=crea_test.js.map